...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13395 = 0;while(true){
...
{var i_13402 = (self__.level + 1);while(true){
if((i_13402 <= (new_level + 1)))
{(update[i_13402] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13404 = 0;while(true){
if((i_13404 <= self__.level))
{var links_13405 = (update[i_13404]).forward;if(((links_13405[i_13404]) === x__$1))
{(links_13405[i_13404] = (x__$1.forward[i_13404]));
{
var G__13406 = (i_13404 + 1);
i_13404 = G__13406;
continue;
}
} else
{{
var G__13407 = (i_13404 + 1);
i_13404 = G__13407;
continue;
}
}
