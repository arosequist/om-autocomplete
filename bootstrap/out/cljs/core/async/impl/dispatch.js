...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13430 = 0;while(true){
var m_13431 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13431 == null))
{} else
{m_13431.call(null);
if((count_13430 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13432 = (count_13430 + 1);
count_13430 = G__13432;
continue;
}
} else
{}
